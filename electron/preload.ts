...
const electronAPI: ElectronAPI = {
    ...
    findSimilar: (modelId, limit) => ipcRenderer.invoke('find-similar', modelId, limit),
    getEmbeddingStats: () => ipcRenderer.invoke('ai:embedding-stats'),
    buildEmbeddings: () => ipcRenderer.invoke('ai:build-embeddings'),
    cancelEmbeddingBuild: () => ipcRenderer.invoke('ai:cancel-embeddings'),
