...
export const AI_PRESETS = [
    ...
    { id: 'caner', name: 'openai.caner.in (remote)', baseUrl: 'https://openai.caner.in/v1', model: 'google/gemma-4-e4b' },
    { id: 'caner-local', name: 'openai.caner.in (local)', baseUrl: 'http://localhost:11435/v1', model: 'google/gemma-4-e4b' },
] as const;
